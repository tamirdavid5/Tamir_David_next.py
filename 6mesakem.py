...
def connect_points(point_list):
    # Separate x and y coordinates from the point list
    x_coords = point_list[::2]
    y_coords = point_list[1::2]

    # Connect the points with lines
    for i in range(len(x_coords) - 1):
        plt.plot([x_coords[i], x_coords[i+1]], [y_coords[i], y_coords[i+1]], 'b')

    # Add the last line to connect the last and first points
...
# Draw lines for the first and second point lists
connect_points(first)
connect_points(second)
